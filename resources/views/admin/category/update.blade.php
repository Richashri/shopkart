        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/category-update', $edit_category->id) }}" method="post" id="category_edit_form" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="slug" id="slug" value="{{ $edit_category->slug }}" placeholder="category-name-xyz">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="description" id="description">{{ $edit_category->description }}</textarea>
                            </div> 
                        
                            <div class="form-group">
                                <label for="image">Category Image</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" value="{{ $edit_category->image }}" accecpt="image/png, image/jpeg" name="image" id="customFile">
                                    <label class="custom-file-label" for="customFile"></label>
                                </div>
                                @if($edit_category->image != '')
                                <div id="remove_after_del">
                                    <div class="filtr-item col-sm-2" data-category="1" data-sort="white sample">
                                        <a href="{{ $site_url.env('IMG_ADMIN_PATH').$edit_category->image }}" data-toggle="lightbox" data-title="{{ $edit_category->name }}">
                                            <img src="{{ $site_url.env('IMG_ADMIN_PATH').$edit_category->image }}" class="img-fluid mb-2" alt="white sample"/>
                                        </a>
                                        
                                    </div>
                                    <a href="javascript:void(0)" id="cat_id" data-token="{{ csrf_token() }}" data-image="{{ $edit_category->image }}" data-id="{{ $edit_category->id }}" >Delete Category Image</a>
                                </div>
                                @endif
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="meta_description" id="meta_description">{{ $edit_category->meta_description }}</textarea>
                            </div> 
                            <div class="form-group">
                                <label for="meta_keywords">Meta Keywords</label>
                                <textarea class="form-control" rows="5" name="meta_keywords" id="meta_keywords">{{ $edit_category->meta_keywords }}</textarea>
                            </div> 
